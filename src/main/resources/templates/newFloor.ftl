...
<@c.page>
    <form action="/newFrame/${id}" method="post">
        <div>
            <h5>Коробка</h5>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label-sm">Высота этажа:</label>
                <div class="col-sm-10">
                    <input type="text" name="height" class="form-control form-control-sm w-25">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                <select name="outWallWidth" class="form-control form-control-sm w-25">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="square" class="form-control form-control-sm w-25">
                </div>
            </div>
            <h5>Окна и двери</h5>
...
<#--            </div>-->
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="outOsbId" class="form-control form-control-sm w-25">
                        <option value="" selected disabled hidden>Выбрать</option>
                        <#list osb as osb>
                            <option value=${osb.id}>${osb.name}</option>
                        </#list>
                    </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="outWaterId" class="form-control form-control-sm w-25">
                        <option value="" selected disabled hidden>Выбрать</option>
                        <#list water as water>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="outWindId" class="form-control form-control-sm w-25">
                        <option value="" selected disabled hidden>Выбрать</option>
                        <#list wind as wind>
                            <option value=${wind.id}>${wind.name}</option>
                        </#list>
                    </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="outWarmId" class="form-control form-control-sm w-25">
                        <option value="" selected disabled hidden>Выбрать</option>
                        <#list warm as warm>
                            <option value=${warm.id}>${warm.name}</option>
                        </#list>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label-sm">ОСБ:</label>
                <div class="col-sm-10">
                    <select name="inOsbId" class="form-control form-control-sm w-25">
                        <option value="" selected disabled hidden>Выбрать</option>
                        <#list osb as osb>
                            <option value=${osb.id}>${osb.name}</option>
                        </#list>
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label-sm">ОСБ:</label>
                <div class="col-sm-10">
                    <select name="overOsbId" class="form-control form-control-sm w-25">
                        <option value="" selected disabled hidden>Выбрать</option>
                        <#list osb as osb>
                            <option value=${osb.id}>${osb.name}</option>
                        </#list>
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label-sm">Парогидроизоляция:</label>
                <div class="col-sm-10">
                    <select name="overWaterId" class="form-control form-control-sm w-25">
                        <option value="" selected disabled hidden>Выбрать</option>
                        <#list water as water>
                            <option value=${water.id}>${water.name}</option>
                        </#list>
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label-sm">Ветрозащита:</label>
                <div class="col-sm-10">
                    <select name="overWindId" class="form-control form-control-sm w-25">
                        <option value="" selected disabled hidden>Выбрать</option>
                        <#list wind as wind>
                            <option value=${wind.id}>${wind.name}</option>
                        </#list>
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label-sm">Теплоизоляция:</label>
                <div class="col-sm-10">
                    <select name="overWarmId" class="form-control form-control-sm w-25">
                        <option value="" selected disabled hidden>Выбрать</option>
                        <#list warm as warm>
                            <option value=${warm.id}>${warm.name}</option>
                        </#list>
